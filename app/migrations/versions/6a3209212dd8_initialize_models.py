...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "PAID", "OVERDUE", name="invoicestatusenum"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("MONTHLY", "QUARTERLY", "YEARLY", name="plantypeenum"),
            nullable=False,
        ),
        sa.Column("cost_euro", sa.Numeric(), nullable=False),
        sa.Column("seat_based", sa.Boolean(), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(
            ["product_uuid"],
    ...
    op.create_table(
        ...
        sa.Column("uuid", sa.UUID(), nullable=False),
        sa.Column("products_customer_uuid", sa.UUID(), nullable=False),
